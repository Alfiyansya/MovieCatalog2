package com.alfian.moviecatalog2.util
...
object DataDummy {
    ...
    fun generateDummyMovies(): List<Show> {
    ...
    fun generateDummyTvShows(): List<Show> {
//      key 1 = TvShow
